...
/*   Updated: 2022/11/12 18:15:43 by ggosse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort(int argc, t_list **stack_a, t_list **stack_b)
{
	...
	if (argc == 4)
		...
		ft_sort_all(stack_a, stack_b, size_a);
	(void)stack_a;
	(void)stack_b;
}
...
void	ft_sort_three(t_list **stack_a, t_list **stack_b)
{
	...
	if (ft_is_sorted(stack_a) == 0)
		printf(BACK_RED" NO "RESET"\n");
	else
		printf(BACK_GREEN" OK "RESET"\n");
	(void)stack_a;
	(void)stack_b;
}
...
{
	ft_pre_sort(stack_a, stack_b, size_a);
}
