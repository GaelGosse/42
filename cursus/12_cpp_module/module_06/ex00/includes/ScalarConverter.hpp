...
/*   Updated: 2023/12/11 16:39:55 by ggosse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class ScalarConverter
{
	public:
		...
		static void	displayInt(int org, std::string str);
		static void	displayChar(char org, std::string str);
		static void	displayFloat(float org, std::string str);
		static void	displayDouble(double org, std::string str);
