...
/*   Updated: 2023/11/16 16:47:40 by ggosse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef AWRONG_ANIMAL_HPP
# define AWRONG_ANIMAL_HPP
...
class AWrongAnimal
{
		public:
			...
			AWrongAnimal(const AWrongAnimal& src);
			AWrongAnimal&operator=(const AWrongAnimal& src);
