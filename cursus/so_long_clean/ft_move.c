...
/*   Updated: 2023/02/05 18:02:29 by ggosse           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_move_w(t_game *game)
{
		...
		game->map->map_org[game->map->p_y - 1][game->map->p_x] == 'C')
	{
		...
		"./sprites/ship_t_f.xpm", &game->img_size, &game->img_size);
		if (game->img_p == NULL)
		{
...
void	ft_move_s(t_game *game)
{
		...
		game->map->map_org[game->map->p_y + 1][game->map->p_x] == 'C')
	{
		...
		mlx_destroy_image(game->mlibx, game->img_p);
		game->img_p = mlx_xpm_file_to_image(game->mlibx,
		"./sprites/ship_b_water.xpm", &game->img_size, &game->img_size);
		if (game->img_p == NULL)
		{
			ft_putstr_fd("Error\nproblem with image...", 2);
			ft_destroy_and_free(game);
...
void	ft_move_a(t_game *game)
{
		...
		game->map->map_org[game->map->p_y][game->map->p_x - 1] == 'C')
	{
		...
		mlx_destroy_image(game->mlibx, game->img_p);
		game->img_p = mlx_xpm_file_to_image(game->mlibx,
		"./sprites/ship_l_water.xpm", &game->img_size, &game->img_size);
		if (game->img_p == NULL)
		{
			ft_putstr_fd("Error\nproblem with image...", 2);
			ft_destroy_and_free(game);
