...
echo -e $RED"./pipex infile \"/usr/bin/ls -l -a\" \"wc -l\" \"grep -v 1\" outfile"$RST"\n"
valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes ./pipex infile "/usr/bin/ls -l -a" "wc -l" "grep -v 1" outfile
